/*
Deployment script for ReactionTimerDB
...
GO
:setvar DatabaseName "ReactionTimerDB"
:setvar DefaultFilePrefix "ReactionTimerDB"
:setvar DefaultDataPath "C:\Users\karta\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\ProjectsV13\"
:setvar DefaultLogPath "C:\Users\karta\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\ProjectsV13\"
...
GO
PRINT N'Creating unnamed constraint on [dbo].[GameScore]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[HighScore]...';


GO
ALTER TABLE [dbo].[HighScore]
    ADD FOREIGN KEY ([userID]) REFERENCES [dbo].[User] ([Id]);
